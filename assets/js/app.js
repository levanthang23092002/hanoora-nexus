(function () {
    ...
    var I18N = {
        en: {
            "nav.0": "Home", "nav.1": "Platform", "nav.2": "Capabilities", "nav.3": "About", "nav.4": "The flow", "nav.5": "Contact",
            "hero.eyebrow": "Light of Hanoi · AI Core",
            "hero.line1": "Data flows in", "hero.line2": "Hanoora Nexus", "hero.line3": "powers your app",
            "hero.lead": "Hanoi + noor (light) — a central node where data is processed by AI logic and delivered into your applications.",
            ...
            "about.eyebrow": "Our story", "about.title1": "Light of", "about.title2": "Hanoi",
        ...
        vi: {
            ...
            "hero.lead": "Hanoi + noor (ánh sáng) — lõi trung tâm nơi dữ liệu được xử lý bằng AI và đưa vào ứng dụng.",
            ...
            "about.eyebrow": "Câu chuyện", "about.title1": "Ánh sáng", "about.title2": "Hà Nội",
        ...
        de: {
            ...
            "hero.lead": "Hanoi + Noor (Licht) — ein zentraler Knoten, an dem Daten per KI-Logik verarbeitet und in Apps geliefert werden.",
            ...
            "about.eyebrow": "Unsere Geschichte", "about.title1": "Licht von", "about.title2": "Hanoi",
